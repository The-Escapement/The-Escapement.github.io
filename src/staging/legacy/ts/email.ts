...
export class EmailSubscription {
  ...
  init(): void {
    ...
    const fullNameElement = document.querySelector("#input-name");
    const emailElement = document.querySelector("#input-email");
    const submitElement =
      this.subscriptionForm.querySelector("#button-subscribe");
    const fullNameErrorElement = document.querySelector("#error-name");
